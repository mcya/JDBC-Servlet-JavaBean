...
insert into product values (9,'世界上最美的英文','   本书详细讲解了各种优美英文的写作语法，以及日常生活中常用的实用语句， 比如：<br/>\r\n  <li>The success belongs to Persistence!!!</li> <br/><li>Nothing is impossible!!!</li>',25.0,2,'Harry David Thoreau','英语出版社',396,'images/product/english1.gif');
insert into product values (10,'汉语言文学',' 这是一本中国之大典，记录了中国文学之完美，博大之精深，是一本受之无穷的书，你一定要拥有哦！！！',109,3,'中国','文学出版社',1200,'images/product/wenxue.gif');
commit;
